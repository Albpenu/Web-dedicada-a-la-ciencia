    ...
    // Registro de usuario:
        ...
        if($contrasenia==$repcontrasenia){
            if($comprobar_email>0){
                ...
                $consulta = mysqli_query($connect, "INSERT INTO usuarios (id_usuario, alias, contrasenia, email, fecha_alta, sabiduria, imagendeperfil) VALUES ('', '$alias', '$contrasenia', '$email', NOW(), 'Sabe cositas', '$imagen')");
