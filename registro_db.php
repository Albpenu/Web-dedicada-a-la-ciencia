    ...
    // Registro de usuario:
        ...
        if($contra==$repcontra){
            if($comprobar_email>0){
                ...
                $consulta = mysqli_query($connect, "INSERT INTO usuarios (id_usuario, alias, contrasenia, email, fecha_alta, sabiduria, imagendeperfil) VALUES ('', '".utf8_encode($alias)."', '$contra', '$email', NOW(), 'Es su primerita vez', '$img')");
